  ...
  return (
    <div>
      <li className="relative bg-white flex flex-col justify-between items-center shadow-md hover:shadow-xl rounded-md overflow-hidden transition-shadow duration-150 m-[10px]">
        <Link className="contents" to={`/category/${listing.type}/${id}`}>
          ...
          <div className="w-full p-[5px]">
            <div className=" flex items-center space-x-1">
              ...
              <p className='font-semibold text-sm mb-[-2px] text-blue-600 truncate'> {listing.address} </p>
            </div>
              <p className="font-semibold mt-2 text-xl text-[#457b9d] truncate">
               {listing.name} 
               </p>
        ...
        {onEdit && (
          <MdEdit className='absolute bottom-2 right-7 h-4 cursor-pointer text-blue-600' 
